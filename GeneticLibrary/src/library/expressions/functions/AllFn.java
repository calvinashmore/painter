...
public class AllFn implements AllComponents<ExpressionFunction> {
   public List<ExpressionFunction> allInstances(ContextModel cm) {
      ...
      r.addAll(new CellularAutomata().allInstances(cm));
      ...
      r.addAll(new IFSExpressions().allInstances(cm));
      r.addAll(new Images().allInstances(cm));
      ...
      r.addAll(new SheepVariations().allInstances(cm));
