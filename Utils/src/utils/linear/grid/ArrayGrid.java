        ...
        implements Grid<T>, Linear<Grid<T>>
{
    ...
    public T getValue(int x, int y) {return values[x][y];}
    public void setValue(int x, int y, T val) {values[x][y] = val;}
    ...
    public ArrayGrid<T> zero() {return new ArrayGrid<T>();}
    
    void assertSize(Grid g) {assertSize(g,null);}
    ...
    public ArrayGrid<T> rescale(int nxres, int nyres) {return rescale(nxres,nyres,GridScaleMethod.linear);}
