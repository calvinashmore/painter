...
public final class Buffers implements AllComponents<StatementFunction>, Described {
   ...
   public static class loop_critical1_buffer_d extends StatementFunction {

      private LDouble critical;
      ...
      public void setParameter(int i, Object value) {
         switch(i) {
            case 0: critical = (LDouble) value; return;
            default: return;
         }
      ...
      public loop_critical1_buffer_d() {
         addGroupMeta(this);
         addMeta("selectionWeight", 3);
      ...
      public void execute(Context context, List<GeneticComponent> inputs) throws TerminationException {
         ...
         pos = new LVect2d ( ( double ) x / xRes , ( double ) y / yRes ) ; context.setVariable(__pos, pos);
         value = buffer . getValue ( x , y ) ; context.setVariable(__value, value);
         if ( value . val > critical . val ) body . execute ( context ) ;
         }
      }

   }

   public static class loop_critical2_buffer_d extends StatementFunction {
      ...
      public loop_critical2_buffer_d() {
         addGroupMeta(this);
         addMeta("selectionWeight", 3);
         critical = new LDouble ( .2 + .6 * Math . random ( ) ) ;
      }
   ...
   public List<StatementFunction> allInstances(ContextModel cm) {
      ...
      r.add(new loop_critical1_buffer_d());
      r.add(new loop_critical2_buffer_d());
      return r;
   }
