 ...
 */
public class Estimate_v2 extends Estimate {
    ...
    public Estimate_v2(double xMinimum, double xMaximum, double yMinimum, double yMaximum) {
    ...
    public Estimate_v2(utils.linear.LVect2d min, utils.linear.LVect2d max) {
        this.xMinimum = min.x;
        this.xMaximum = max.x;
        this.yMinimum = min.y;
        this.yMaximum = max.y;
