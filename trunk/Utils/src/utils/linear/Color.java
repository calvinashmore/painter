...
public class Color implements Linear<Color>{
    ...
    public Color zero() {return new Color();}
    
    public Color add(Color a) {return new Color(r+a.r, g+a.g, b+a.b);}
    public void addv(Color a) {r += a.r; g += a.g; b += a.b;}
    
    public Color sub(Color a) {return new Color(r-a.r, g-a.g, b-a.b);}
    public void subv(Color a) {r -= a.r; g -= a.g; b -= a.b;}
    
    public Color mult(double c) {return new Color(c*r, c*g, c*b);}
    public void multv(double c) {r *= c; g *= c; b *= c;}
